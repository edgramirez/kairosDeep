...
def set_aforo_reference_line_coordinates(value):
    global reference_line_coordinates
...
set_aforo_reference_line_coordinates(srv_aforo['aforo_reference_line_coordinates'])

read_camera_mac_address()
set_outside_area(srv_aforo['outside_area'])
set_server_url()
